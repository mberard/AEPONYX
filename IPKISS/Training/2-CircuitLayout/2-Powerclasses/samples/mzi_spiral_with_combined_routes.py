...
class Circuit(APAC):
    ...
    def get_cr1(self):
        ...
        t1 = i3.Translation(insts["bp1"].size_info().north_west) + i3.Translation((0, 20))
        t2 = i3.Translation(insts["bp2"].size_info().south_east) - i3.Translation((0, 20))
        cr = combine_connectors([manhattan, sbend, manhattan], [t1, t2])
        return cr

    def get_cr2(self):
        insts = self.get_child_instances()
        t1 = i3.Translation((insts["bp3"].size_info().south_west)) - i3.Translation((0, 5))
        cr = combine_connectors([manhattan, manhattan], [t1])
        return cr
